...
export const QUERY_MAP: { query: string; path: string }[] = [
  { query: 'Vente matériel boxe', path: '/boutique-boxe/' },
  { query: 'Boutique boxe', path: '/boutique-boxe/' },
  { query: 'Matos boxe', path: '/boutique-boxe/' },
  { query: 'Matériel boxe', path: '/materiel-boxe/' },
  { query: 'Équipement boxe anglaise', path: '/materiel-boxe/' },
  { query: 'Matériel MMA', path: '/materiel-mma/' },
  { query: 'Équipement MMA', path: '/materiel-mma/' },
  { query: 'Matériel sport de combat', path: '/materiel-sport-de-combat/' },
  { query: 'Sport de combat', path: '/materiel-sport-de-combat/' },
  { query: 'Boutique sport de combat France', path: '/materiel-sport-de-combat/' },
  { query: 'Boutique arts martiaux', path: '/boutique-arts-martiaux/' },
  { query: 'Arts martiaux', path: '/boutique-arts-martiaux/' },
  { query: 'Vente gants de boxe', path: '/gants-de-boxe/' },
  { query: 'Gants boxe', path: '/gants-de-boxe/' },
  { query: 'Gants MMA', path: '/gants-mma/' },
  { query: 'Accessoires boxe', path: '/accessoires-boxe/' },
  { query: 'Protections boxe', path: '/protections-boxe/' },
  { query: 'Textile boxe', path: '/textile-boxe/' },
  { query: 'Sac de frappe', path: '/sacs-de-frappe/' },
  { query: 'Chaussures de boxe', path: '/chaussures-boxe/' },
];
